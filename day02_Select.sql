...
-- Q1 Derecesi Derecesi 90'dan yuksek olan ogrencilerin tum bilgilerini getirin.
SELECT * 
FROM meslek_lisesi 
WHERE derece>90;
...
/*-------------------------------------------------------------------------
Q6: Ankara ile Corum arasinda olan ogrencilerin isimlerini ve adreslerini listeleyin.
---------------------------------------------------------------------------*/
SELECT isim,adres
FROM ogretmen_lisesi
WHERE adres
