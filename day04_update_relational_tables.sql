...
-- Ali Can'in aldigi urunun ismini Apple olarak degistirin (urun_idim yapmışım artık öyle devam)
update urun
set urun_idim='Apple'
...
/*-------------------------------------------------------------------------
5) Tum cocuklarin grade'lerini puanlar tablosundaki yazili notlari ile update edin. 
--------------------------------------------------------------------------*/
...
-- 3) Ismi A ile başlayan butun musterilerin urun_fiyatlarini %15 artirin 
update mart_satislar
set urun_fiyat=(urun_fiyat)+(urun_fiyat*15/100)
