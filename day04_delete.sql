...
WHERE veli_isim = 'Ali' or veli_isim = 'Ayse';  -- WHERE (veli_isim IN('Ali','Ayse')) //bu satır böyle de yazılabilirdi
...
-- 3.yontem <> bu işaret de 85 dışındakiler anlamına gelir
DELETE FROM cucuklar
WHERE  yazili_notu<>85;
