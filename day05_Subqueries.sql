...
----------------------------------------------------------------*/
-- 1. Adim: Personel sayisi 15000 den buyuk olan sirketleri listeleyelim
select sirket
from sirketler
where personel_sayisi>15000; -- ford ve toyota dondurur

-- 2.Adim: Ford ve Toyota da calisan personeli listeleyelim

select isim,sirket
from personel
where sirket IN ('Toyota', 'Ford');

-- 3.Adim: Personel sayisi 15000 den cok olan sirketleri ve bu sirketlerde calisan personeli listeleyelim
select isim,sirket
from personel
where sirket IN (select sirket
				from sirketler
				where personel_sayisi>15000); -- bu sekilde komut dinamik hale geldi. tabloda yapilacak degisiklikler icin de sorgu calisir

-- Honda sirketinin personel sayisini 16000 olarak degistirelim
update sirketler
